...
public class AddEmp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Employe");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jesal)
                            .addComponent(jename)
                            .addComponent(jeno, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void addbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbuttonActionPerformed
        if (jeno.getText().isEmpty() || jename.getText().isEmpty() || jesal.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Incomplete details");
            return;
        }

        String ename = jename.getText().trim();

        try {
            int enumber = Integer.parseInt(jeno.getText().trim());
            Double esalary = Double.parseDouble(jesal.getText().trim());
            EmpPojo obj = new EmpPojo(enumber, ename, esalary);
            if (Empdao.addEmp(obj))
            JOptionPane.showMessageDialog(null, "Employe added sucessfully");
            else
            JOptionPane.showMessageDialog(null, "Employe not added sucessfully");
